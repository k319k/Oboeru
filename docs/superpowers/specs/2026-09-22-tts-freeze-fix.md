...
- **順序**: ①フリーズ修正 (本spec) → ✓**②UI強化 — 完了 (2026-09-26)** (類似度画面の即スキップ防止・
  ボタン常時下部・スマホでキーボンドヒント非表示。仕様は `docs/superpowers/specs/2026-09-26-ui-enhancement.md`、
  計画は `docs/superpowers/plans/2026-09-26-ui-enhancement.md`。手動遷移化・練習中ナビ非表示・
  テーマ3択の移設も同時に完了) → ③PWA (Android) → ④トラック×子チャプター統合 (名称はトラック) →
